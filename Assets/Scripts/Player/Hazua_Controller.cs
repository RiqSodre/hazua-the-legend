...
public class Hazua_Controller : MonoBehaviour
{
    ...
    float groundRadius = 0.2f;         //Cria um raio de 0.2f em volta do Hazua.
    ...
    bool doubleJump = false;           //Váriavel booleana para o pulo duplo.
